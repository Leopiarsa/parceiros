...
export class Initial1744109227135 implements MigrationInterface {
    name = 'Initial1744109227135'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "parceiros" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "telefone" character varying(255) NOT NULL, "ativo" boolean NOT NULL DEFAULT true, "userID" bigint, CONSTRAINT "PK_c641dd3567834fa7ae0d67e4835" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "oportunidades" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "cpf" character varying(30) NOT NULL, "cep" character varying(255) NOT NULL, "cidade" character varying(255) NOT NULL, "logradouro" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "telefone" character varying(255) NOT NULL, "fonte" character varying(255) NOT NULL, "tipoDeContato" character varying(255) NOT NULL, "tipoDeAcao" character varying(255) NOT NULL, "principioAtivo" character varying(255) NOT NULL, "observacao" character varying(255), "comentario" character varying(255), "file_path" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9cc49a8d41b2a5acf30d752b2bb" PRIMARY KEY ("id"))`);
