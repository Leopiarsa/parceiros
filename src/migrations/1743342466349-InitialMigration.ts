...
export class InitialMigration1743342466349 implements MigrationInterface {
    name = 'InitialMigration1743342466349'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "parceiros" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "userID" bigint, CONSTRAINT "PK_c641dd3567834fa7ae0d67e4835" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "oportunidades" ("id" SERIAL NOT NULL, "nome" character varying(255) NOT NULL, "telefone" character varying(255) NOT NULL, "endereco" character varying(255) NOT NULL, "file_path" text, "tipoDeContato" character varying(255) NOT NULL, "fonte" character varying(255) NOT NULL, "tipoDeAcao" character varying(255) NOT NULL, "cpf" character varying(11) NOT NULL, "comentario" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9cc49a8d41b2a5acf30d752b2bb" PRIMARY KEY ("id"))`);
